  ...
  return (
    <div className="welcome-container">
      ...
      <p>
        ...
        available at the grocery store you shop at?
      </p>
      <div></div>
      <p>
      ...
      <div></div>
      <p>
        Our master chefs have crafted delicious recipes for you to choose from.
        And guess what? All of the ingredients can be found in our grocery
        store. As an added bonus, our amazing web developer has crafted a
        website you can use to search recipes and generate a grocery list from
        the ingredients in those recipes.{" "}
      </p>
      <div></div>
      <p>
        ...
        finished building your Grocery List, you can download a PDF of your list
